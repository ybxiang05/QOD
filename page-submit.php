         ...
         <section class="quote-submission">
            ...
            <?php if ( is_user_logged_in() && current_user_can( 'edit_posts' ) ) : ?>
               ...
               <div class="quote-submission-wrapper">
                  ...
                  <p class="submit-success-message" style="display:none;">Thanks, your quote was received!</p>
                  <p class="submit-fail-message" style="display:none;">Something has gone wrong. Please check your input and try again.</p>
               </div>
